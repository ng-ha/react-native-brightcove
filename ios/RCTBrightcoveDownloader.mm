...
- (void)pauseVideoDownload:(nonnull NSString *)id
                   resolve:(nonnull RCTPromiseResolveBlock)resolve
                    reject:(nonnull RCTPromiseRejectBlock)reject {
  [downloader pauseVideoDownloadWithOfflineVideoToken:id resolve:resolve reject:reject];
}

- (void)resumeVideoDownload:(nonnull NSString *)id
                    resolve:(nonnull RCTPromiseResolveBlock)resolve
                     reject:(nonnull RCTPromiseRejectBlock)reject {
  [downloader resumeVideoDownloadWithOfflineVideoToken:id resolve:resolve reject:reject];
}

- (void)deleteVideo:(nonnull NSString *)id
            resolve:(nonnull RCTPromiseResolveBlock)resolve
             reject:(nonnull RCTPromiseRejectBlock)reject {
  [downloader deleteVideoWithOfflineVideoToken:id resolve:resolve reject:reject];
}
